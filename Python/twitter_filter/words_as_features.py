...
# def load_and_train_dataset_w_words_as_features():

class words_classifier():
   def __init__(self,load_train='load'):
      assert load_train in ('load','train')

      self.voted_classifier = 0
      self.all_words = {}
   ...
   def train(self,with_print=True):
      ...
      featuresets = [(self.find_features(rev,self.word_features), category) for (rev, category) in documents]
      ...
      if with_print: print("Original Naive Bayes Algo accuracy percent:", (nltk.classify.accuracy(Naivebayes_classifier, testing_set)) * 100)
      if with_print: Naivebayes_classifier.show_most_informative_features(15)
      ...
      with open(getcwd()+"\\classifiers\\words_as_features\\MNB_classifier.pickle", "wb") as classifier_f:
         ...
         classifier_f.close()
      if with_print: print("MNB_classifier accuracy percent:", (nltk.classify.accuracy(MNB_classifier, testing_set)) * 100)
      ...
      with open(getcwd()+"\\classifiers\\words_as_features\\BernoulliNB_classifier.pickle", "wb") as classifier_f:
         ...
         classifier_f.close()
      if with_print: print("BernoulliNB_classifier accuracy percent:", (nltk.classify.accuracy(BernoulliNB_classifier, testing_set)) * 100)
      ...
      with open(getcwd()+"\\classifiers\\words_as_features\\LogisticRegression_classifier.pickle", "wb") as classifier_f:
         ...
         classifier_f.close()
      if with_print: print("LogisticRegression_classifier accuracy percent:",(nltk.classify.accuracy(LogisticRegression_classifier, testing_set)) * 100)
      ...
      with open(getcwd()+"\\classifiers\\words_as_features\\SGDClassifier_classifier.pickle", "wb") as classifier_f:
         ...
         classifier_f.close()
      if with_print: print("SGDClassifier_classifier accuracy percent:", (nltk.classify.accuracy(SGDClassifier_classifier, testing_set)) * 100)
      ...
      with open(getcwd()+"\\classifiers\\words_as_features\\SVC_classifier.pickle", "wb") as classifier_f:
         ...
         classifier_f.close()
      if with_print: print("SVC_classifier accuracy percent:", (nltk.classify.accuracy(SVC_classifier, testing_set))*100)
      ...
      self.voted_classifier = self.VoteClassifier(Naivebayes_classifier,
                                        # SVR_classifier,
                                        MLP_Classifier,
      ...
      if with_print: print("voted_classifier accuracy percent:", (nltk.classify.accuracy(self.voted_classifier, testing_set)) * 100)
   ...
   def load_classifier(self):
      ...
      self.voted_classifier = self.VoteClassifier(
         BernoulliNB_classifier,
         LinearSVC_classifier,
         LogisticRegression_classifier,
         MNB_classifier,
...
# # TESTING
# w = words_classifier(load_train="train")
# # w.load_WAF_vote_classifier()
#
# print('----')
#
# test = "@MizzTink08 dont u WUTEVA me little nigger lol"
#
# test = w.str_to_featureset(test)
#
# print(test)
# print(w.voted_classifier.classify(test))


# load_and_train_dataset_w_words_as_features = ()
# load_WAF_vote_classifier()